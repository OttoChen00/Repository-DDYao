...
public interface CustomerService {
    ...
    @RequestWrapper(localName = "findFixAreaId", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.service.FindFixAreaId")
    @ResponseWrapper(localName = "findFixAreaIdResponse", targetNamespace = "http://service.crm.itheima.com/", className = "com.itheima.crm.service.FindFixAreaIdResponse")
    public String findFixAreaId(
        @WebParam(name = "arg0", targetNamespace = "")
        String arg0);
